 ...
 <nav class="navbar header-navbar pcoded-header">
              <div class="navbar-wrapper">
                  <div class="navbar-logo">
                      ...
                      <a href="index.html">
                          <img width="50px" class="img-fluid" src="<%= request.getContextPath() %>/assets/images/logotipo.png" alt="Theme-Logo" />
                      </a>
                      ...
                      <ul class="nav-right">
                          ...
                          <li class="user-profile header-notification">
                              ...
                              <!--  
                                  ...
                                  <li class="waves-effect waves-light">
                                      <a href="<%= request.getContextPath() %>/ServeletLoguin?acao=logout">
