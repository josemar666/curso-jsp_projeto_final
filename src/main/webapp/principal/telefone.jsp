												...
												<div class="card">
													...
													<div class="card-block">
														<h4 class="sub-title">Cad. Telefone</h4>
															...
															<div class="form-group form-default form-static-label">
                                                                <input readonly="readonly" type="text" name="nome" id="nome" class="form-control" required="required" value="${modelLoguin.nome}">
                                                                <span class="form-bar"></span>
												...
												<tbody>
													<c:forEach items='${modelTelefone}' var='f'>
													      <tr>
													       ...
													       <td><a class="btn btn-success" href="<%= request.getContextPath() %>/ServletTelefone?acao=excluir&id=${f.id}&userpai=${modelLoguin.id}" >EXCLUIR</a></td>
													      </tr>
													</c:forEach>
												</tbody>
											</table>
