...
public class DAOTelefoneRepository {
	...
	public List<ModelTelefone> listFone(Long idUserPai) throws Exception{
		...
		preparedStament.setLong(1, idUserPai);
	...
	public void gravaTelefone(ModelTelefone modelTelefone)throws Exception {
		...
		PreparedStatement preparedStament = connection.prepareStatement(sql);
		preparedStament.setString(1,modelTelefone.getNumero());
		preparedStament.setLong(2, modelTelefone.getUsuario_pai_id().getId());
		preparedStament.setLong(3, modelTelefone.getUsuario_cad_id().getId());
