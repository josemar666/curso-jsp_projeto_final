                          ...
                          <div class="">
                              ...
                              <c:if test="${imagemUser !='' && imagemUser != null}">
                                  <img class="img-80 img-radius" src="${imagemUser}" alt="User-Profile-Image">
                                    ...
                                    <c:if test="${imagemUser =='' || imagemUser == null}">
                                  <img class="img-80 img-radius" src="<%= request.getContextPath() %>/assets/images/logotipo.png" alt="User-Profile-Image">
                                  </c:if>
                                  ...
                                  <ul>
                                      <li class="more-details">
                                        ...
                                        <!--  <a href="#!"><i class="ti-settings"></i>Settings</a>-->
                                          <a href="<%= request.getContextPath() %>/ServeletLoguin?acao=logout"><i class="ti-layout-sidebar-left"></i>SAIR</a>
                                      </li>
                                  </ul>
                              </div>
                          </div>
                        ...
                        <!-- <div class="p-15 p-b-0">
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                              ...
                              <li class="pcoded-hasmenu">
                                  ...
                                  <c:if test="${perfil=='Admin' || perfil=='Admin2'}">
                                      <li class=" ">
